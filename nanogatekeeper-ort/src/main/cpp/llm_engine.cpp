...
Java_com_forgerig_nanogatekeeper_ort_LlmBridge_nativeInit(JNIEnv* env, jobject /*thiz*/,
...
Java_com_forgerig_nanogatekeeper_ort_LlmBridge_nativeGetProvider(JNIEnv* env, jobject /*thiz*/,
                                                                 jlong handle) {
  try {
...
Java_com_forgerig_nanogatekeeper_ort_LlmBridge_nativeGenerate(JNIEnv* env, jobject /*thiz*/,
...
Java_com_forgerig_nanogatekeeper_ort_LlmBridge_nativeRelease(JNIEnv* env, jobject /*thiz*/,
                                                             jlong handle) {
